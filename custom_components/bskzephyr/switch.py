...
class BSKZephyrSelect(SwitchEntity, CoordinatorEntity[DeviceDataUpdateCoordinator]):
    def __init__(self, groupID: str, coordinator: DeviceDataUpdateCoordinator, description: SwitchEntityDescription):
    ...
    def _handle_coordinator_update(self) -> None:
        ...
        self._attr_is_on = getattr(self.coordinator.data[self.groupID].device, self.entity_description.key) == "On"
    ...
    async def set_device_power(self, power: bool) -> None:
        ...
        await self.coordinator.api.control_device(self.groupID, **{self.entity_description.key: on_off})
